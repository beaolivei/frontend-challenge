...
`
class My2015List extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        fetch('http://ergast.com/api/f1/2015/results/1.json')
                        ...
                        function (race, i) {
                            return (
                                <tr>
                                    ...
                                    <td>{race.Results[0].Driver.familyName === "Hamilton" ? "yes" : "no"}</td>
                                </tr>
