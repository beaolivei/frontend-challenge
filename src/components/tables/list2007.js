...
`
class My2007List extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        fetch('http://ergast.com/api/f1/2007/results/1.json')
                        ...
                        function (race, i) {
                            return (
                                <tr>
                                    ...
                                    <td>{race.Results[0].Driver.familyName === "Räikkönen" ? "yes" : "no"}</td>
                                </tr>
