...
`
class My2009List extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        fetch('http://ergast.com/api/f1/2009/results/1.json')
                        ...
                        function (race, i) {
                            return (
                                <tr>
                                    ...
                                    <td>{race.Results[0].Driver.familyName === "Button" ? "yes" : "no"}</td>
                                </tr>
