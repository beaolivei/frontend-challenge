...
`
class My2006List extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        fetch('http://ergast.com/api/f1/2006/results/1.json')
                        ...
                        function (race, i) {
                            return (
                                <tr>
                                    ...
                                    <td>{race.Results[0].Driver.familyName === "Alonso" ? "yes" : "no"}</td>
                                </tr>
